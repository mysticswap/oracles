...
contract OffchainAggregator is Owned, AggregatorV2V3Interface, TypeAndVersionInterface {
   ...
   * @param r serialized report, which the signatures are signing. See parsing code below for format. The ith element of the observers component must be the index in s_signers of the address for the ith signature
